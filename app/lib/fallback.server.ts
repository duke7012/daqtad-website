import { defaultPageSections } from "~/lib/event-sections";
...
const events: EventItem[] = [
  {
    ...
    banner: "/assets/images/events/bopsim2026-bg.jpg",
    requestsOpen: true,
    video: "",
    instagramPosts: "",
    pageSections: defaultPageSections("upcoming"),
    photos: [],
    rounds: [],
  },
  {
    ...
    video: "",
    instagramPosts: "",
    pageSections: defaultPageSections("past"),
    photos: [],
    rounds: [],
  },
  {
